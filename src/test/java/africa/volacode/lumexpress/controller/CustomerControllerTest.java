...
class CustomerControllerTest {
    ...
    void registerControllerTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/customer/").contentType("application/json")
                .content(mapper.writeValueAsString(request))).andExpect(MockMvcResultMatchers.status()
                .is(201))
